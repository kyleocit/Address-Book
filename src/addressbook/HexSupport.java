package addressbook;
/*
 * @(#)HexSupport.java	1.2 10/10/13
 *
 * Source code provided by a third party associated with the Apache
 * Software Foundation. See details below.
 *
 * UML Diagram
 * --------------------------------------------------
 *                    HexSupport
 ...
 * --------------------------------------------------
 *  -HexSupport()
 *  +toBytesFromHex(String): byte[]
 *  +toHexFromBytes(byte[]): String
 *  +toHexFromInt(int,boolean): String
 * --------------------------------------------------
 */
